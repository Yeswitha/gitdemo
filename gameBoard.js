var gameBoard = {
   ...
   // refer to HTML5 drag drop API before you complete following functions
    ...
    dragLeave: function (event) {
        ...
        if(gameBoard.dragged!=event.target.getAttribute('data-value'))
    ...
    dragDrop: function (event) {
        ...
        var $current = $('#grid li[data-value='+current+']');// select li element with data-value of current contained in element with id 'grid'
        var $dragged = $('#grid li[data-value='+gameBoard.dragged+']');// select li element with data-value of gameBoard.dragged contained in element with id 'grid'
    ...
    createGrid: function (aspect, imageUrl) {
        ...
        */
        ...
        var cellWidth = puzzleWidth/game.gridSize;//width of each cell in pixels
        var cellHeight = puzzleHeight/game.gridSize;//height of each cell in pixels
        var percentage = 100/(game.gridSize-1);//how much % of width/height of original image should show in each cell
        ...
        for (var i = 0; i < game.gridSize * game.gridSize; i++) {
            ...
            var xpos =(percentage*(i%game.gridSize))+'%'; //x-position in %units;
            var ypos = (percentage*(Math.floor)(i/game.gridSize))+'%'//y-pos ition in %units;
            var li = $('<li  draggable=true  data-value='+i+'></li>').css
            ({
                "background-image": "url(\""+imageUrl+"\")",
                "background-position": xpos+" "+ypos,
                "background-size":(game.gridSize*100)+'%',
                "width":cellWidth+'px',
